...
use crate::{
    ...
    model::{
        ...
        DownloadDelivery, DownloadGrant, FileResponse, FinalizeAgentTurn,
        FinalizeAgentTurnResult, Item, ListConversationsQuery, ListItemsQuery, RegenerateResult,
        ReplayRequest, ReplayResult, StartTurn, StartTurnResult, StrictJson, TruncateConversation,
        Turn, UpdateConversation, UpdateTurn,
...
pub fn router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/v1/agent-turns/{turn_id}/finalize", post(finalize_agent_turn))
        .route(
            "/v1/conversations/{id}",
